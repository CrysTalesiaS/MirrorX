    ...
    def onUploadComplete(self, link: str, size):
        with download_dict_lock:
            ...
            if SHORTENER is not None and SHORTENER_API is not None:
                ...
                buttons.buildbutton("Klik Disini⚡", surl)
            else:
                buttons.buildbutton("⚡Klik Disini", link)
            ...
            if INDEX_URL is not None:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    ...
                    buttons.buildbutton("🔥Indexnya🔥", siurl)
                else:
                    buttons.buildbutton("🔥Indexnya🔥", share_url)
...
def _mirror(bot, update, isTar=False, extract=False):
    ...
    if not bot_utils.is_url(link) and not bot_utils.is_magnet(link):
        sendMessage('Link download gk ada', bot, update)
        return
    ...
    if bot_utils.is_mega_link(link):
        ...
        if link_type == "folder" and BLOCK_MEGA_FOLDER:
            sendMessage("Mega folder diblockir!", bot, update)
