...
from .modules import authorize, extra, lastfm, list, wiki, gtranslator, paste, cancel_mirror, mirror_status, mirror, clone, watch, shell, eval, anime, stickers, search, delete, speedtest, usage
